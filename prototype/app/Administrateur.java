...
public class Administrateur extends Equipier {
    ...
    public Administrateur(String id, String prenom, String nomDeFamille, int numeroDeTele, String adresseCourriel, String lienWeb, Condition titre, Superviseur superviseur, ArrayList<Activite> inscrireActivite, ArrayList<Interet> inscrireInteret) {
