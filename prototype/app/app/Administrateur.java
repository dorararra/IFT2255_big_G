...
public class Administrateur extends Equipier {
    ...
    public Administrateur(String id, String prenom, String nomDeFamille, String numeroDeTele, String adresseCourriel,
						  String lienWeb, Condition titre, Superviseur superviseur,
						  ArrayList<Activite> inscrireActivite, ArrayList<Interet> inscrireInteret,
						  ArrayList<Notification> listeNotification) {
        super(id, prenom, nomDeFamille, numeroDeTele, adresseCourriel, lienWeb, titre,  inscrireActivite, inscrireInteret, listeNotification);
